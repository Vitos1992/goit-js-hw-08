...
const itemsMarkup = createGalleryItemsMarkup((0, _galleryItems.galleryItems));
...
var SimpleLightbox = /*#__PURE__*/ function() {
    function SimpleLightbox1(elements, options) {
        ...
        if (this.options.disableRightClick) this.addEventListener(document.body, "contextmenu." + this.eventNamespace, function(event) {
            if (event.target.classList.contains("sl-overlay")) event.preventDefault();
        });
         // keyboard-control
        ...
        },
        {
            ...
            value: function adjustImage(direction) {
                ...
                tmpImage.addEventListener("load", function(event) {
                    ...
                    _this5.isOpen = true;
                    var captionContainer = _this5.options.captionSelector === "self" ? _this5.relatedElements[_this5.currentImageIndex] : _this5.relatedElements[_this5.currentImageIndex].querySelector(_this5.options.captionSelector), captionText;
                    ...
                    if (_this5.relatedElements.length === 1) _this5.hide(_this5.domNodes.navigation.querySelectorAll(".sl-prev, .sl-next"));
                        ...
                        if (_this6.controlCoordinates.touchCount === 1) /* Single touch */ {
                            if (!_this6.controlCoordinates.doubleTapped) {
                                ...
                                if (!_this6.controlCoordinates.zoomed) {
                                    ...
                                    if (!_this6.domNodes.caption.style.opacity && _this6.domNodes.caption.style.display !== "none") _this6.fadeOut(_this6.domNodes.caption, _this6.options.fadeSpeed);
...
parcelHelpers.export(exports, "imgArr", ()=>imgArr);
var _galleryItems = require("./gallery-items");
const galleryItems = [
    {
...
const imgArr = (0, _galleryItems.galleryItems).map(({ preview , original , description  })=>{
    return;
}).join("");

},{"./gallery-items":"9C7dK","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gkKU3":[function(require,module,exports) {
